...
/** comment by hy 2020-06-12
 * # 使能管道写 如果使能enable_pipelined_write则走这个分支
 */
...
/** comment by hy 2020-06-13
 * # 下面处理状态为STATE_GROUP_LEADER，即作为整个batch的leader
 */
...
/** comment by hy 2020-06-13
 * # 默认为NULL, 如果使用 WriteWithCallback 调用
 */
