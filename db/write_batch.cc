 ...
 * # 插入数据时：type（kTypeValue、kTypeDeletion）
                 Key_size，Key，Value_size，Value
     删除数据时：type（kTypeValue、kTypeDeletion）
                 Key_size，Key
 */
...
/*****************************************************************************
 * 函 数 名  : WriteBatch.Iterate
 * 负 责 人  : hy
 * 创建日期  : 2020年6月28日
 * 函数功能  :  
 * 输入参数  : Handler* handler : MemTableInserter
 * 输出参数  : 无
 * 返 回 值  : Status
 * 调用关系  : 
 * 其    它  : 
